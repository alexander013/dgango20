    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_skill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.skill')),
                ('id_word', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.word')),
            ],
        ),
        migrations.CreateModel(
            name='Vacancy',
            fields=[
                ...
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.area')),
                ('employer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.employer')),
                ('schedule', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.schedule')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.type')),
                ('word_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blogapp.word')),
            ],
        ),
    ]
